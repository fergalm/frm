...
"""
    ...
    Given a set of points, (x,y), compute and plot the properties of
    ...
    * A vector from the centre pointing along the semi-minor axis,
    ...
    TODO make it easy to switch between showing rings versus filled ellipses.
    Choose sensible defaults for both.
    Add Mahanoblis distance 

"""


def plot(x, y, idx=None, levels=None, **kwargs):
    if not levels:
        levels = [.69, .95, .997]
